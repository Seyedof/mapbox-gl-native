...
//IMGUI_IMPL_API void     ImGui_ImplGPU_RenderDrawData(ImDrawData* draw_data);

// (Optional) Called by Init/NewFrame/Shutdown
//IMGUI_IMPL_API bool     ImGui_ImplGPU_CreateFontsTexture();
//IMGUI_IMPL_API void     ImGui_ImplMBGL_DestroyFontsTexture();
//IMGUI_IMPL_API bool     ImGui_ImplGPU_CreateDeviceObjects();
